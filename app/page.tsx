...
// Removed HRBehavioralDataPoint interface as it's no longer needed for static mockup
...
export default function HRInterviewSimulatorPage() {
  ...
  // Removed hrBehavioralData, currentEmotion, currentConfidence states

  const handleHRResumeUpload = async (file: File) => {
    // Simulate upload and directly set stage to mode-selection with static data
